...
class ModelMAE(nn.Module):
    def __init__(
        ...
        self.perception_lane_pred = nn.Linear(embed_dim, 20 * 2)
    ...
    def forward(self, data):
        ...
        perception_lane_pred = self.perception_lane_pred(perception_lane_token).view(B, M, 20, 2)
        ...
        if not self.training:
            ...
            out["perception_lane_hat"] = perception_lane_pred.view(B, M, 20, 2)
