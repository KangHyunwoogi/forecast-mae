...
def visualize_trajectories(trainer, predicted_trajectory, gt_trajectory, batch_idx, y_hat):
    drawer = Drawer()
    ...
    # 이미지 저장
    drawer.save_plot(f'/home/ailab/Desktop/wook/forecast-mae/visualization/jiwon_batch_50/trajectory_plot_epoch_{epoch}_batch_{batch_idx}.png')
    drawer.clear()
...
class Trainer(pl.LightningModule):
    ...
    def cal_loss(self, out, data, batch_idx):
        ...
        if batch_idx % 50 == 0 and self.save_visualization:
            visualize_trajectories(self, reshaped_vocabulary_trajectory, gt_trajectory, batch_idx, y_hat)
